/*
CH-230-A
a10_p4.cpp  critter.cpp
yassin youssef
yyoussef@constructor.university
*/
#include "Critter.h"
using namespace std;
Critter::Critter() : name("default_critter"), hunger(0), boredom(0), height(5){/*first critter that isnt supplied with anything
and has the default inputs*/
    cout << "1 = default is called" << endl;
}
Critter::Critter(const string& name) : name(name), hunger(0), boredom(0), height(5) {/*the critter with only name parameter 
